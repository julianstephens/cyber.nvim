...
local on_attach = function(client, bufnr)
  ...
  buf_set_keymap("n", "<leader>oa", "<cmd>lua require('telescope.builtin').lsp_code_actions(require('telescope.themes').get_cursor())<CR>", opts)
  -- buf_set_keymap("n", "<leader>oa", "<cmd>lua vim.lsp.buf.code_action()<CR>", opts)
...
-- 	buf_set_keymap("n", "<C-f>", "<cmd>lua vim.lsp.buf.formatting()<CR>", opts)
  vim.cmd([[
    autocmd CursorHold * lua vim.diagnostic.open_float({focusable = false, scope = 'line'})
  ]])
