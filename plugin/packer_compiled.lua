...
_G.packer_plugins = {
  ...
  ["glow.nvim"] = {
    config = { "\27LJ\2\2A\0\0\2\0\4\0\a6\0\0\0'\1\1\0B\0\2\0029\0\2\0005\1\3\0B\0\2\1K\0\1\0\1\0\1\nwidth\3x\nsetup\tglow\frequire\0" },
    loaded = true,
  ...
  ["telescope-env.nvim"] = {
    loaded = true,
    path = "/home/julian/.local/share/nvim/site/pack/packer/start/telescope-env.nvim",
